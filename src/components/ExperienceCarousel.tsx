...
import { Sparkles, ChevronLeft, ChevronRight, Play, Pause, ArrowRight } from 'lucide-react';
...
export const ExperienceCarousel: React.FC<ExperienceCarouselProps> = ({ onExploreClick }) => {
    ...
    <section id="travel-experiences" className="py-14 sm:py-20 bg-gradient-to-b from-white via-slate-50/50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8 sm:mb-10">
          From tranquil tea plantations in Munnar to private houseboat backwater sunsets — discover what awaits you in God&apos;s Own Country.
        </p>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-8">
            <button
              ...
              className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl bg-[#0B3996] hover:bg-[#082a70] text-white text-sm font-bold shadow-md hover:shadow-lg transition-all active:scale-95 cursor-pointer"
            >
              <span>Explore Kerala Tour Packages</span>
