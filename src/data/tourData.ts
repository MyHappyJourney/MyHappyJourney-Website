import { PackageItem, ItineraryDay, Review, FAQItem, TrustItem, DestinationItem } from '../types';
...
export const COMPANY_ADDRESS = "3 rd floor, 18th Main Rd, Kumaraswamy Layout 2nd Stage, Kumaraswamy Layout, Bengaluru, Karnataka 560078";
export const WHATSAPP_DEFAULT_MSG = encodeURIComponent("Hi MyHappyJourney, I am visiting your website and interested in your Kerala Tour Packages. Please share more details and availability.");
export const WHATSAPP_GROUP_MSG = encodeURIComponent("Hi MyHappyJourney, I am planning a Kerala tour for a group of 10+ travelers. Please share group itinerary options and package details.");
...
export const DESTINATIONS: DestinationItem[] = [
  ...
  },
  {
    ...
    tagline: "Venice of the East & Backwater Houseboat Capital",
    image: "https://hczb7fxersozfdoh.public.blob.vercel-storage.com/hb.jpg",
    highlights: ["Overnight Deluxe Houseboat Cruise", "Vembanad Lake Sunset", "Canal Kayaking & Village Walks", "Fresh Kerala Backwater Cuisine"],
    idealFor: "Couples, Relaxed Travelers, Food Lovers",
    bestSeason: "Year-Round (Best Oct–March)",
    packageCount: 4
  },
  {
    id: "dest-thekkady",
    name: "Thekkady (Periyar)",
    tagline: "Untamed Wildlife, Spice Plantations & Nature Trails",
    image: "https://hczb7fxersozfdoh.public.blob.vercel-storage.com/ThekkadyPeriyarRiver.jpg",
    highlights: ["Periyar Lake Boat Safari", "Organic Cardamom & Pepper Spice Tours", "Kathakali & Kalaripayattu Cultural Shows", "Elephant Encounters"],
    idealFor: "Wildlife Buffs, Adventure Seekers, Culture Explorers",
  ...
  },
  {
    id: "dest-kovalam",
    name: "Kovalam & Poovar",
    tagline: "Golden Sands, Iconic Lighthouse & Mangrove Estuaries",
    image: "https://hczb7fxersozfdoh.public.blob.vercel-storage.com/kids-having-fun-in-the-beach-with-their-mother.jpg",
    highlights: ["Lighthouse Beach & Crescent Shorelines", "Poovar Golden Sand Mangrove Boating", "Sree Padmanabhaswamy Temple", "Coastal Seafood Dining"],
    idealFor: "Beach Lovers, Sun Seekers, Spiritual Travelers",
