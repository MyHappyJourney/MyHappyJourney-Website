...
1. `/<destination>/<destination>-honeymoon-packages/`
2. `/<destination>/<destination>-family-holiday-packages/`
3. `/<destination>/<destination>-senior-citizen-tours/`
4. `/<destination>/<destination>-group-tour-packages/`
5. `/<destination>/<destination>-luxury-holiday-packages/`
...
- Routes reusing a dedicated page's content redirect to that page's existing 
  thank-you page (e.g. /kerala/kerala-honeymoon-packages/ → /kerala-honeymoon/thank-you)
...
- Routes: src/app/kerala/kerala-honeymoon-packages/page.tsx, 
  src/app/kerala/kerala-family-holiday-packages/page.tsx, 
  src/app/kerala/kerala-senior-citizen-tours/page.tsx, 
  src/app/kerala/kerala-group-tour-packages/page.tsx, 
  src/app/kerala/kerala-luxury-holiday-packages/page.tsx, 
